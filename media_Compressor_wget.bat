...
echo --------------------------------------
echo.
echo - please copy wget.exe to %InstallPath% and try again
echo.
...
echo --------------------------------------
echo.
echo - please copy 7za.exe to %InstallPath% and try again
echo.
echo - hit key for download
echo.
echo --------------------------------------
pause
start "" "http://downloads.sourceforge.net/project/sevenzip/7-Zip/9.20/7za920.zip"
exit
...
echo --------------------------------------
pause
%InstallPath%\wget http://downloads.sourceforge.net/project/avisynth2/AviSynth%202.5/AviSynth%202.5.8/Avisynth_258.exe
%InstallPath%\Avisynth_258.exe
...
echo --------------------------------------
echo.
echo - install devIL.dll to SysWOW64 or System32
echo.
echo --------------------------------------
%InstallPath%\wget https://sourceforge.net/projects/openil/files/DevIL%20Win32/1.7.8/DevIL-EndUser-x86-1.7.8.zip

if exist "%windir%\SysWOW64" %InstallPath%\7za e DevIL-EndUser-x86-1.7.8.zip -o%windir%\SysWOW64 *.dll -r -y
if exist "%windir%\System32" %InstallPath%\7za e DevIL-EndUser-x86-1.7.8.zip -o%windir%\System32 *.dll -r -y
...
%InstallPath%\wget http://www.videohelp.com/download/MP4Box-0.4.6-rev2735.zip?r=FdvVPLGq
%InstallPath%\7za e MP4Box-0.4.6-rev2735.zip -o%InstallPath% *.exe -r -y
del "tools@d=MP4Box-0.4.6-rev2735.zip"
